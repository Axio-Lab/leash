...
| Folder   | What it does                                                                                                                                                                                     |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `leash/` | Build, monetise, and operate Solana agents that pay each other in real SPL stables via x402/MPP, including hosted payment links that forward to existing APIs and document expected POST bodies. |
