...
| **Facilitator** (`facilitator-devnet.leash.market` devnet, `facilitator.leash.market` mainnet, or any compatible host) | Nothing                                                        | —                                | Pays the **network fee** to broadcast `payTo` |
  ...
  "accepts": [
    {
      ...
      "feePayer": "facilitator-devnet.leash.market",
...
| ---------------- | ----------------------------------------- | ----------------------------------------------------------- |
| `solana-devnet`  | `https://facilitator-devnet.leash.market` | Leash-operated devnet, gas-sponsored, Token-2022 supported. |
| `solana-mainnet` | `https://facilitator.leash.market`        | Leash-operated mainnet, gas-sponsored.                      |

Third-party alternatives (all wire-compatible): `facilitator-devnet.leash.market` (devnet), `facilitator.leash.market` (mainnet), community hosts, self-hosted `@leashmarket/facilitator`.
