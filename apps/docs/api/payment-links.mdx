---
title: 'Payment links'
description: Hosted x402 or MPP payment links at /x/{id} — the "Stripe Payment Link" for agent commerce.
---
...
the response template to return on success. Optional **`protocol`**
...
configured response. Funds settle directly into the **owner agent's
