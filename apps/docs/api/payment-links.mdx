...
[`@leash/buyer-kit`](/sdk/buyer-kit)) hit it, get a `402` with
...
| Charge per call on a route in your existing Hono app     | [`@leash/seller-kit`](/sdk/seller-kit)    |
...
- [`@leash/seller-kit`](/sdk/seller-kit) — the same middleware,
