...
[`@leash/buyer-kit`](/sdk/buyer-kit): a function passed as `onReceipt`
...
[buyer endpoints](/api/buyer) mirror `@leash/buyer-kit` **but execute on
...
hosted, or any self-hosted facilitator running `@leash/facilitator`)
