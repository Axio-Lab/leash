...
If you've used `@leashmarket/registry-utils` in TypeScript, every
...
- [Identity API](/api/identity) — handles, verified domains, capability cards, claims, and public verification.
