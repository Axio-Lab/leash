...
description: 'Drop Leash into Cursor, Claude Desktop, Cline, Continue, or ChatGPT-MCP. STDIO transport, 11 tools, zero browser in the loop.'
---
...
The MCP exposes 11 canonical tools. Each is also available through
...
You should see all 11 `leash_*` tools. If you don't, check the
