...
description: 'Drop Leash into Cursor, Claude Desktop, Cline, Continue, or ChatGPT-MCP. STDIO transport, 14 tools, zero browser in the loop.'
---
...
The MCP exposes 14 canonical tools. Each is also available through
...
You should see all 14 `leash_*` tools. If you don't, check the
