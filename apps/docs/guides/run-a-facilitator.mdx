...
description: 'Use facilitator.leash.market (mainnet) / facilitator-devnet.leash.market (devnet), or self-host @leashmarket/facilitator.'
---

> Leash operates two public facilitators: **`https://facilitator.leash.market`** (mainnet)
> and **`https://facilitator-devnet.leash.market`** (devnet). These are the SDK defaults.
...
| ----------- | ----------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| **Devnet**  | `https://facilitator-devnet.leash.market` | `https://facilitator-devnet.leash.market`, `http://localhost:8787` (local `@leashmarket/facilitator-app`) |
