...
const METADATA_JSON_EXAMPLE_HREF =
  'https://github.com/Axio-Lab/leash/blob/main/apps/playground/lib/example.json';
...
export default function NewAgentPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <PageHeader
        eyebrow="leash · playground · createAgent"
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_22rem]">
        ...
        <div className="flex flex-col gap-4">
            ...
            <CardContent className="text-xs text-fg-muted leading-relaxed flex flex-col gap-2">
              {!PRIVY_APP_ID ? (
                <span>
                  ...
                  <code className="font-mono">apps/playground/.env.local</code> and restart{' '}
          ...
          {result && (
            <Card className="border-brand/40 glow motion-safe:[animation:var(--animate-row-in)]">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-sm">
