...
export default function AgentsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        eyebrow="leash · playground · agents"
        title="Your agents."
      ...
      <Card>
        ...
        <CardContent>
          {agents.length === 0 ? (
            <div className="rounded-md border border-dashed border-border p-8 text-center text-sm text-fg-muted motion-safe:[animation:var(--animate-fade-in)]">
            ...
            <ul className="flex flex-col divide-y divide-border">
              {agents.map((a, i) => {
                ...
                return (
                  <li
                    key={a.mint}
                    className="flex items-center gap-3 py-3 motion-safe:[animation:var(--animate-row-in)]"
